    ...
    return (
        <div className="max-w-4xl mx-auto p-6 lg:p-6 space-y-8 animate-fade-in">
            ...
            <div>
                ...
                <p className="text-slate-500 mt-2 font-medium">Nyeri Collection Point #04</p>
            </div>
                ...
                <Routes>
                    <Route index element={
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-fade-in">
                            ...
                            <div className="lg:col-span-2 bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
                                ...
                                <EventLogForm farmers={farmers} plots={plots} onSuccess={() => navigate('queue')} />
                            </div>
                        </div>
                    } />
                    ...
                    <Route path="onboarding" element={
                        <div className="max-w-2xl mx-auto space-y-8 animate-fade-in">
                            ...
                            <FarmerOnboardingForm onSuccess={() => navigate('/')} />
                        </div>
                    } />

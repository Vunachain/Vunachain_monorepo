      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative z-10">
            ...
            <div className="mt-6 flex items-center justify-center gap-4">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-gray-500">Export Compliance Director, Leading Tea Exporter</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-8 md:gap-16 opacity-80">
          ...
          <div className="flex flex-col items-center gap-2 group cursor-default transition-transform duration-300 hover:-translate-y-2">
            ...
            <span className="text-sm font-semibold text-gray-600 dark:text-gray-400 group-hover:text-primary transition-colors duration-300">ISO 27001 Security</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-2 group cursor-default transition-transform duration-300 hover:-translate-y-2">
            ...
            <span className="text-sm font-semibold text-gray-600 dark:text-gray-400 group-hover:text-primary transition-colors duration-300">Tea Act 2020 Ready</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-2 group cursor-default transition-transform duration-300 hover:-translate-y-2">
            ...
            <span className="text-sm font-semibold text-gray-600 dark:text-gray-400 group-hover:text-primary transition-colors duration-300">GDPR & Kenya DPA</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-2 group cursor-default transition-transform duration-300 hover:-translate-y-2">
            ...
            <span className="text-sm font-semibold text-gray-600 dark:text-gray-400 group-hover:text-primary transition-colors duration-300">Carbon-Neutral Infra</span>
          </div>
